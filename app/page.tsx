...
export async function generateMetadata(){const page=await getPublishedCmsPage("/");return page?{title:page.seoTitle??page.title,description:page.seoDescription??undefined,robots:page.noindex?{index:false,follow:false}:undefined,alternates:{canonical:"/"}}:{alternates:{canonical:"/"}};}
