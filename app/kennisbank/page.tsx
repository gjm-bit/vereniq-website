...
// SEO Vindbaarheid 2.0: de kennisbank bevat vandaag 0 artikelen (localArticles
// is een lege array) - een geïndexeerde pagina die alleen "binnenkort meer"
// zegt, is precies het type dunne content dat Google's kwaliteitssignalen
// kan schaden. Tijdelijk noindex (wél follow, interne links blijven
// crawlbaar) totdat er echte artikelen staan (zie het kennisbankplan in het
// eindrapport) - dan hoort deze regel verwijderd te worden.
export const metadata={title:"Kennisbank",description:"Praktische informatie over verenigingsbeheer, digitalisering, privacy en slimmer organiseren.",alternates:{canonical:"/kennisbank"},robots:{index:false,follow:true}};
