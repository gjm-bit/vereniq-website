...
/**
 * Veiligheidsgrens voor het lezen van de request-body: een geldige, kleine
 * JSON-body (een handvol URL's) parseert normaliter in enkele milliseconden,
 * dus 2000ms is ruim voldoende marge boven het normale geval. Voorkomt dat
 * een onverwacht hangende request-body deze route tot Vercel's platformlimiet
 * laat doorlopen - geeft in plaats daarvan direct een gecontroleerde 408.
 */
