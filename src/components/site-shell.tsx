...
/** Volgorde is product-bepaald: Facebook → Instagram → YouTube → LinkedIn → WhatsApp. */
export const SOCIAL_ICONS: Readonly<Record<keyof OrganizationFooterData["social"], { label: string; path: string }>> = {
  ...
  whatsapp: { label: "WhatsApp", path: "M12 2C6.48 2 2 6.48 2 12c0 1.85.5 3.58 1.35 5.08L2 22l5.06-1.33C8.51 21.5 10.2 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm5.2 14.15c-.22.62-1.28 1.2-1.76 1.27-.45.07-1.02.1-1.65-.1-.38-.12-.87-.28-1.5-.55-2.64-1.14-4.36-3.8-4.49-3.98-.13-.17-1.07-1.42-1.07-2.71 0-1.29.68-1.92.92-2.18.24-.26.53-.33.7-.33h.5c.16 0 .38-.06.6.46.22.53.75 1.82.82 1.95.06.14.11.29.02.47-.09.17-.13.28-.26.43-.13.16-.27.35-.38.47-.13.13-.26.26-.11.51.15.25.65 1.07 1.39 1.73.95.85 1.76 1.11 2.01 1.24.24.13.39.11.53-.06.15-.17.62-.72.78-.97.16-.24.33-.2.55-.12.22.08 1.4.66 1.63.78.24.12.39.18.45.28.06.1.06.57-.16 1.19z" },
};
